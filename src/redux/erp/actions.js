...
export const erp = {
  ...
  list:
    ...
    async (dispatch) => {
      ...
      console.log('📥 erp.list response:', data);
      ...
      if (data && data.success === true) {
        ...
        console.log('✅ Dispatching REQUEST_SUCCESS with result:', result);
        dispatch({
        ...
        console.log('❌ Request failed or no success:', data);
        dispatch({
  ...
  create:
    ...
    async (dispatch) => {
      ...
      console.log('📦 Create response:', { entity, success: data?.success, result: data?.result, message: data?.message });
