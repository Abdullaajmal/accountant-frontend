const lang = {
  ...
  'Balance Sheet is not Balanced': 'Balance Sheet is not Balanced',
  'Commission Report': 'Commission Report',
  'Group by Supplier': 'Group by Supplier',
  'Group by Booking': 'Group by Booking',
  ...
  'Booking Profit Analysis': 'Booking Profit Analysis',
  'Profit Analysis': 'Profit Analysis',
  'Select Booking (Optional)': 'Select Booking (Optional)',
  ...
  'Quotes to Bookings': 'Quotes to Bookings',
  'Booking Calendar': 'Booking Calendar',
  'Bookings on': 'Bookings on',
  'Business Insights': 'Business Insights',
  'Top Packages by Revenue': 'Top Packages by Revenue',
  'Low Profit Bookings': 'Low Profit Bookings',
  'Booking Count': 'Booking Count',
  'Revenue, Expense & Profit Trend': 'Revenue, Expense & Profit Trend',
  'Charts require recharts library. Please install: npm install recharts': 'Charts require recharts library. Please install: npm install recharts',
